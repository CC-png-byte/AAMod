...
{
    public class AncientRazewoodDrawer : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Ancient Razewood Drawer");
			AddMapEntry(new Color(70, 40, 30));
			dustType = mod.DustType("RazewoodDust");
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Ancient Razewood Drawer";
			dresserDrop = mod.ItemType("AncientRazewoodDrawer");
		}
