...
namespace AAMod.Tiles.Furniture.Daybreak
{
    public class DaybreakDresser : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Daybreak Dresser");
            AddMapEntry(new Color(176, 74, 39), name);
            dustType = mod.DustType("DaybreakDust");
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Daybreak Dresser";
			dresserDrop = mod.ItemType("DaybreakDresser");
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				if (player.showItemIconText == chest)
				{
					player.showItemIcon2 = mod.ItemType("DaybreakDresser");
					player.showItemIconText = "";
				}
			}
			player.noThrow = 2;
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("Glowmasks/DaybreakDresser_Glow"), new Vector2((i * 16) - (int)Main.screenPosition.X, (j * 16) - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}
	}
}
